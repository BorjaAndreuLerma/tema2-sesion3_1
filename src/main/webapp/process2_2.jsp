<%-- 
    Document   : process2_2
    Created on : 26-sep-2016, 9:19:59
    Author     : alumno
--%>
...
<html>
    ...
    <body>
        ...
        <br><b>¡Esta respuesta ha sido generada desde un JSP independizado de la 
            lógica de negocio que produjo el JavaBean que usa!</b>
    </body>
</html>
